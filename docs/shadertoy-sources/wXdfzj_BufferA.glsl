...
[ 简介 / Introduction ]
    ...
    相机可在全空间内自由移动。此外，我们实现了kn时空最大延拓的完整内容，
    但是暂未同步到这个shadertoy版本。你可以去下面的GitHub链接体验它。
    ...
    Furthermore, the complete maximal extension of Kerr-Newman spacetime is now available. 
    While not yet updated in this Shadertoy shader, it can be accessed through the GitHub repository linked below.
